...
<p align="center">
  <img src="https://skillicons.dev/icons?i=py,java,c,html,css,js,ts,react,nodejs,npm,vite,bash,vim,neovim,vscode,vscodium,androidstudio,eclipse,anaconda,git,github,vercel,netlify,fastapi,firebase,postman,gcp,docker,kubernetes,githubactions,mysql,sqlite,postgres,redis,mongodb,supabase,nginx,raspberrypi,linux,arch,kali,ubuntu,debian,mint,fedora&theme=dark" />
</p>
